...
#load data
df_lpi <- read.csv("../Mammalian-Fast-Slow-Stability//Data/Living Planet Index/LPD2022_public/LPD2022_public.csv", header = T)
...
df_lpi_true_rm <- df_sub_lpi_tf %>% filter(
  ...
  #All TS with 10 or more years of Data to be removed
    ...
    #All TS with 5 or More years of Data to be removed
           ...
           ID == 11284 | ID == 11297 | ID == 11901 | ID == 13483 | ID == 13490 | ID == 17826 | ID == 18004 | ID == 18256 | ID == 18311 |
...
#write.csv(df_lpi_ts_rm_st, "../Mammalian-Fast-Slow-Stability//Data/Living Planet Index/TS_lpi_all_trended.csv")
...
#write.csv(df_lpi_notrend, "../Mammalian-Fast-Slow-Stability//Data/Living Planet Index/TS_lpi_notrend.csv")
...
#write.csv(df_lpi_detrended_notrend, "../Mammalian-Fast-Slow-Stability//Data/Living Planet Index/TS_lpi_detrended.csv")
