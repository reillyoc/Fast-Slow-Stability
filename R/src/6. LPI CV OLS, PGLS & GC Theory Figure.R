...
#ggsave("../Mammalian-Fast-Slow-Stability/Figures/Figure S3 - Body Mass vs CV Terrestrial Mammals.jpeg", plot = gg_cv_bs_5, width = 8, height = 6)
...
#ggsave("../Mammalian-Fast-Slow-Stability/Figures/Figure S2 - LH Trait BS Overlap.jpeg", plot = gg_met_grw_mort_cv_ol_3, width = 6, height = 8)
...
#ggsave("../Mammalian-Fast-Slow-Stability/Figures/Figure 2 - CV body size + Residual Traits + PC1 vs Log CV.jpeg", plot = gg_big_panel, width =10, height = 10)
